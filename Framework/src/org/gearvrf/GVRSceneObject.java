...
public class GVRSceneObject extends GVRHybridObject {
    ...
    public GVRSceneObject(GVRContext gvrContext, GVRMesh mesh,
            GVRTexture texture, GVRMaterialShaderId shaderId, Boolean arObj,
            Boolean isAr) {
        this(gvrContext, mesh);
     ...
     * {@linkplain Texture 'texture shader'} to display a
     * {@linkplain GVRTexture texture.}
     * 
     * @param gvrContext
     *            current {@link GVRContext}
     * @param width
     ...
     * 
     * @param minRange
     *            The closest distance to the camera rig in which this object
     *            should be shown. This should be a positive number between 0
     *            and Float.MAX_VALUE.
     * @param maxRange
     *            The farthest distance to the camera rig in which this object
     *            should be shown. This should be a positive number between 0
     *            and Float.MAX_VALUE.
     */
...
class NativeSceneObject {
    ...
    static native void setLODRange(long sceneObject, float minRange,
            float maxRange);
